...
// on mount, fetch all categories and one product data to stored them as this component's state
    componentDidMount: function(){
        // read categories
        this.serverRequestCat = $.get("http://localhost/develop/api/category/read.php",
            function (categories) {
                this.setState({
        ...
        this.serverRequestProd = $.get("http://localhost/develop/api/product/read_one.php?id=" + productId,
            function (product) {
